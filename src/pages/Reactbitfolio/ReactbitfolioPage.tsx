...
const ReactbitfolioPage = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-[100vh] w-screen overflow-x-hidden flex flex-col bg-[#fbf8f5]">
      ...
      />
        ...
        <nav className="overflow-hidden flex items-center justify-between w-[90%] lg:w-[900px] px-[18px] sm:px-[24px] py-[12px] sm:py-[16px] rounded-[40px] bg-white/70 backdrop-blur-xl border border-white/30 fixed top-[20px] left-1/2 -translate-x-1/2 z-[99]">
...
export default ReactbitfolioPage