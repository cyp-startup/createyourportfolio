...
const TemplatesPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh_-_67px)] bg-[#fbf8f5] pb-[32px]">
      <section className="max-w-[1500px] mx-auto pt-[120px] px-[16px] relative">
        ...
        <div className="flex items-center justify-between mb-[42px]">
          <div className="min-w-[550px] grid grid-cols-4 p-[4px] rounded-[16px] bg-[#f1f1f1]/70 backdrop-blur-xl border-[0.5px] border-[#e6e6e6]">
            <button 
            ...
            >
              <p className="text-[0.938rem] font-semibold font-roboto-flex text-center leading-[100%]">All</p>
            </button>
            <button 
            ...
            >
              <p className="text-[0.938rem] font-semibold font-roboto-flex text-center leading-[100%]">Free</p>
            </button>
            <button 
            ...
            >
              <p className="text-[0.938rem] font-semibold font-roboto-flex text-center leading-[100%]">Pro</p>
            </button>
            <button 
            ...
            >
              <p className="text-[0.938rem] font-semibold font-roboto-flex text-center leading-[100%]">VIP</p>
            </button>
          </div>

          {/* Search input */}
          <div className="bg-white rounded-[24px] border-[0.5px] border-[#e6e6e6] flex items-center gap-[4px] min-w-[360px]">
            <input 
              name="search-input" 
              value={search}
              ...
              <>
                ...
                {groupedTemplates.free.length > 0 && (
                  <div>
                    ...
                    <div className="flex gap-[24px] lg:gap-[32px] flex-wrap">
                      {groupedTemplates.free.map(template => (
                        <TemplateCard
                          className="!w-[30.7%] lg:!w-[31%] xl:!w-[23%]"
                          key={template.id}
