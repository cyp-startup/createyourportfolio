  ...
  return (
    <div
      className={`sticky top-0 ${
        position > 50
          ? "bg-picto-soft-white border-b border-gray-300"
      ...
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            smooth={true}
            duration={900}
            className="flex items-center border-0 lg:max-picto-xxl:ps-5"
          >
        ...
        <div className="lg:flex items-center">
          ...
          <p className="">
            <Link
              className="btn btn-sm picto-xs:btn-md sm:btn-lg btn-primary"
              href="#contact"
              to={`contact`}
              smooth={true}
              duration={900}
