...
const Roles = ({ role }: RolesProps) => {
  ...
  return (
    <div
      ...
      className="p-4 picto-xs:p-8 bg-white hover:shadow-xl h-auto shadow-gray-300 ease-out duration-800 rounded-lg my-6 flex relative overflow-hidden"
    >
      <p
        className={`bg-picto-primary absolute start-0 w-0 h-full mt-[-16px] picto-xs:mt-[-32px] ${
