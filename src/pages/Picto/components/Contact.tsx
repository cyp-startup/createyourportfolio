        ...
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            <div>
              ...
              <p className="text-[12px] picto-xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-picto-soft-dark">
          ...
          <div className="w-full overflow-y-scroll py-6.5">
            <p className="text-xl mb-2 picto-xs:text-2xl sm:text-2xl md:text-[38px] font-semibold text-[#132238] lg:hidden text-center">
              Let’s discuss your Project
            </p>
            <Form />
          </div>
