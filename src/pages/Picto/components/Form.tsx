...
const Form = () => {
  return (
    <div>
      <p className="text-[12px] picto-xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-picto-soft-dark">
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4">
          ...
          <div className="flex max-picto-xs:flex-col max-picto-xs:gap-4">
            <input
              type="text"
              placeholder="Budget*"
              className={`${commonClass} picto-xs:w-[50%] me-5`}
              required
            />
            <input
              type="text"
