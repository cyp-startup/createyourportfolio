...
const MonoBlog = ({ data }: MonoBlogProps) => {
    return (
      <div className="overflow-hidden rounded-lg border border-gray-100 hover:shadow-2xl bg-white shadow-gray-300 transition-all duration-300">
        <a href={data?.link}>
          ...
          />
          <div className="m-6">
            <p className="text-[10px] picto-xs:text-[14px] font-normal text-gray-400 ">
              {data?.date} / {data?.comments} Comments
            </p>
            <p className="text-[14px] picto-xs:text-lg font-medium text-[#333333]">
