  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <section 
          ref={ref}
          className={`overflow-x-visible w-full lg:min-h-[220vh] bg-[radial-gradient(circle_at_center,_#7ea6ec_0%,_#3d7eed_80%)] relative z-[55] py-[40px] transition-[border-radius] duration-500 ease-out
